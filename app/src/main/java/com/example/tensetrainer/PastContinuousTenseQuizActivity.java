...
public class PastContinuousTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_past_continuous_tense_quiz);
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(PastContinuousTenseQuizActivity.this, ScoreActivity.class);
