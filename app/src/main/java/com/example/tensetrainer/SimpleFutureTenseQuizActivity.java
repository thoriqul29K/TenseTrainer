...
public class SimpleFutureTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_future_tense_quiz);
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(SimpleFutureTenseQuizActivity.this, ScoreActivity.class);
