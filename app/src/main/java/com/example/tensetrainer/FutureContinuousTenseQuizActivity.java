...
public class FutureContinuousTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_future_continuous_tense_quiz);
    ...
    private void calculateScore() {
        ...
        if (selectedIdQuestion2 == R.id.answer2a) {
            score++;
        }
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(FutureContinuousTenseQuizActivity.this, ScoreActivity.class);
