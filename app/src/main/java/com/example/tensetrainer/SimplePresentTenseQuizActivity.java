...
public class SimplePresentTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_present_tense_quiz);
    ...
    private void calculateScore() {
        ...
        if (selectedIdQuestion1 == R.id.answer1b) {
            score++;
        }
        ...
        if (selectedIdQuestion5 == R.id.answer5a) {
            score++;
        }

        // Question 6
        int selectedIdQuestion6 = radioGroupQuestion6.getCheckedRadioButtonId();
        if (selectedIdQuestion6 == R.id.answer6d) {
            score++;
        }
        ...
        if (selectedIdQuestion8 == R.id.answer8a) {
            score++;
        }
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(SimplePresentTenseQuizActivity.this, ScoreActivity.class);
