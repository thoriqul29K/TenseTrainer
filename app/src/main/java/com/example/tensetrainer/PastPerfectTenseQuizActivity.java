...
public class PastPerfectTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_past_perfect_tense_quiz);
    ...
    private void calculateScore() {
        ...
        if (selectedIdQuestion1 == R.id.answer1a) {
            score++;
        }
        ...
        if (selectedIdQuestion4 == R.id.answer4d) {
            score++;
        }
        ...
        if (selectedIdQuestion7 == R.id.answer7d) {
            score++;
        }
        ...
        if (selectedIdQuestion10 == R.id.answer10a) {
            score++;
        }
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(PastPerfectTenseQuizActivity.this, ScoreActivity.class);
