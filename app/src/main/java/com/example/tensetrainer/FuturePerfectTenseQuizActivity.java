...
public class FuturePerfectTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_future_perfect_tense_quiz);
    ...
    private void calculateScore() {
        ...
        if (selectedIdQuestion2 == R.id.answer2d) {
            score++;
        }
        ...
        if (selectedIdQuestion9 == R.id.answer9d) {
            score++;
        }

        // Question 10
        int selectedIdQuestion10 = radioGroupQuestion10.getCheckedRadioButtonId();
        if (selectedIdQuestion10 == R.id.answer10d) {
            score++;
        }
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(FuturePerfectTenseQuizActivity.this, ScoreActivity.class);
