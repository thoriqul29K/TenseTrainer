...
public class PresentPerfectTenseQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_present_perfect_tense_quiz);
    ...
    private void calculateScore() {
        ...
        if (selectedIdQuestion1 == R.id.answer1c) {
            score++;
        }
        ...
        if (selectedIdQuestion3 == R.id.answer3c) {
            score++;
        }
    ...
    private void showScore(int score) {
        ...
        // Example:
        Intent intent = new Intent(PresentPerfectTenseQuizActivity.this, ScoreActivity.class);
